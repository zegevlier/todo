  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gray-50 p-8 sm:p-12">
      <div className="w-full max-w-4xl rounded-md border-2 border-gray-100 bg-white p-10 pb-8">
        <div className="flex flex-col items-center">
          ...
          >
            <input
              ...
              className="grow rounded border-2 border-gray-300 py-3 px-3 focus:border-emerald-700 focus:outline-none sm:rounded-l-md sm:rounded-r-none sm:border-r-0"
        ...
        <div className="mt-3">
          <div className="border rounded-md cursor-pointer p-2 w-full">
      ...
      <footer className="absolute bottom-0 p-3 text-sm flex justify-center items-center">
        <p className="p-2">
          Created by{" "}
          <a
            className="underline"
